...
Ext.onReady(function(){
    ...
    //first drop down menu of all time olympic games
	...
	//second drop down menu sochi 2014
	...
	//third drop down menu of olympic of switzerland
...
//add names to the drop down menu
    tb.add({
